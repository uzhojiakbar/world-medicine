...
import {Container,Header,Grid,Subtext,Field,Fotercontainer,FooterButtons,IMG,ImgContainer,HR,PackageList,GridItem,Btn} from './Style'
            ...
            <StyledModal title={null} open={isOpen} onCancel={onClose} footer={null} width={800}>
                <Container>
                    ...
                    <Grid>
                        ...
                        <Field>
                            <p>Место работы</p>
                            <Subtext>{modal1Data.workplace} <i className="fa-solid fa-pen"></i></Subtext>
                        </Field>
                        <Field>
                    ...
                    <Btn>Условие работы {modal1Data.condition}</Btn>
                    ...
                    <Grid>
                        ...
                        <div>
                            <GridItem>
                                ...
                                <div>{modal1Data.period}</div>
                            </GridItem>
                            <GridItem mt={12}>
                                <p>Цель:</p>
                                <div><span>{modal1Data.goal}</span> {modal1Data.km}</div>
                            </GridItem>
                        </div>
                    </Grid>
