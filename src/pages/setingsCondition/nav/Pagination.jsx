...
const Pagination = () => {
    ...
    const RegionsIcon = () => {
        return <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path opacity="0.5"
                  d="M39.433 40.7248C42.286 39.1692 44 37.1746 44 35C44 32.695 42.0744 30.5922 38.9074 29C35.2452 27.1588 29.9234 26 24 26C18.0767 26 12.7548 27.1588 9.09262 29C5.9257 30.5922 4 32.695 4 35C4 37.305 5.9257 39.4078 9.09262 41C12.7548 42.8412 18.0767 44 24 44C30.2132 44 35.7646 42.725 39.433 40.7248Z"
                  fill={active === "regions" ? "white" : "#216BF4"}/>
            <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M10 17.0293C10 9.8334 16.268 4 24 4C31.732 4 38 9.8334 38 17.0293C38 24.1688 33.5316 32.4998 26.5602 35.4792C24.935 36.1736 23.065 36.1736 21.4398 35.4792C14.4683 32.4998 10 24.1688 10 17.0293ZM24 22C26.2092 22 28 20.2092 28 18C28 15.7909 26.2092 14 24 14C21.7908 14 20 15.7909 20 18C20 20.2092 21.7908 22 24 22Z"
                  fill={active === "regions" ? "white" : "#216BF4"}/>
        </svg>
