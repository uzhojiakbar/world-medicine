                    ...
                    <td>
                      {editId === row.id ? (
                        <Input
                          ...
                          name="Каш"
                          value={editedRow.Каш}
                          onChange={(value) => handleInputChange("Каш", value)}
                          placeholder="Enter Каш"
                        />
                      ) : (
                        row?.Каш
                      )}
                    ...
                    <td>
                      {editId === row.id ? (
                        <Input
                          ...
                          name="Сур"
                          value={editedRow.Сур}
                          onChange={(value) => handleInputChange("Сур", value)}
                          placeholder="Enter Сур"
                        />
                      ) : (
                        row?.Сур
                      )}
                    ...
                    <td>
                      {editId === row.id ? (
                        <Input
                          ...
                          name="Джи"
                          value={editedRow.Джи}
                          onChange={(value) => handleInputChange("Джи", value)}
                          placeholder="Enter Джи"
                        />
                      ) : (
                        row?.Джи
                      )}
                    ...
                    <td>
                      {editId === row.id ? (
                        <Input
                          ...
                          name="Сыр"
                          value={editedRow.Сыр}
                          onChange={(value) => handleInputChange("Сыр", value)}
                          placeholder="Enter Сыр"
                        />
                      ) : (
                        row?.Сыр
                      )}
                    ...
                    <td>
                      {editId === row.id ? (
                        <Input
                          type="number"
                          name="Таш_об"
                          value={editedRow.Таш_об}
                          onChange={(value) =>
                            handleInputChange("Таш_об", value)
                          }
                          placeholder="Enter Таш_об"
                        />
                      ) : (
                        row?.Таш_об
                      )}
                    ...
                    <td>
                      {editId === row.id ? (
                        <Input
                          ...
                          name="Хор"
                          value={editedRow.Хор}
                          onChange={(value) => handleInputChange("Хор", value)}
                          placeholder="Enter Хор"
                        />
                      ) : (
                        row?.Хор
                      )}
