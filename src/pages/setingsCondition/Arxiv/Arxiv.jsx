...
import Server, {useGetAllContract} from "../../../utils/server/server.js";
...
const Arxiv = () => {
    ...
    return (
        <Wrapper>
            ...
            <MainTable title="" currentPage={currentPage} setCurrentPage={setCurrentPage} data={[]}  />
        </Wrapper>
    );
};
