...
const AddDoctor = () => {
  ...
  const formDataLabels = {
    title: translate("Добавить менеджера"),
    download: translate("Загрузить базу врачей .xsl"),
    komu: translate("Кому"),
    fullName: translate("Ф.И.О. менеджера"),
    ...
    temporaryPassword: translate("Временный пароль"),
    isAdmin: translate("Добавить администратора"),
  };
  ...
  return (
    <Wrapper>
      <Title className="titlee">
        <div>{translate("Добавление врачаей")}</div>
