...
import {Desc, DisabledPageContainer,LanguageContainer, Footer, Title, TopTitleDisabled} from "./style";
...
const MobileAndTabletError = ({title = "asdasdasd"}) => {
    ...
    return (
        <DisabledPageContainer>
            <Title>
                {translate("mobile-and-tablet-error-title")}
            </Title>
            <Desc>
                {translate("mobile-and-tablet-error")}
            </Desc>
            <Footer>
                <CircleButton
                    className="copy-link"
