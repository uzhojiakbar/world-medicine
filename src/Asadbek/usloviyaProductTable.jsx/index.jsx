...
const UsloviyaProductTable = ({
    ...
    const handleDelete = (id) => {
        tbody = tbody.filter((v) => v.id !== id)
        console.log(tbody, id);

        setData({ ...data, tbody: tbody })
    }
                                                    ...
                                                    if (row[v]?.child) {
                                                                ...
                                                                <>
                                                                    ...
                                                                    <td>
                                                                        <Input
                                                                            type="number"
                                                                            name="Лимит"
                                                                            value={editedRow.Лимит}
                                                                            onChange={(value) => handleInputChange("Лимит", value)}
                                                                            placeholder="Лимит"
                                                                            height={"50px"}
                                                                        />
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <Input
                                                                            type="number"
                                                                            name="Балл"
                                                                            value={editedRow.Балл}
                                                                            onChange={(value) => handleInputChange("Балл", value)}
                                                                            placeholder="Балл"
                                                                            height={"50px"}
                                                                        />
                                                                    </td>
                                                        ...
                                                        return editId !== row.id ? <td key={v.id} className={i == 1 && "idfixed"}>
                                                            ...
                                                            <Input
                                                                type="text"
                                                                name={row[v]}
                                                                value={editedRow[row[v]]}
                                                                onChange={(value) => handleInputChange(row[v], value)}
                                                                placeholder={v}
                                                                height={"50px"}
                                                            />
                                                        </td>
